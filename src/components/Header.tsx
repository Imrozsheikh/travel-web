  ...
  return (
    <header className="sticky top-0 z-50 bg-slate-950/90 backdrop-blur-md border-b border-gray-800">
      ...
      <div className="flex items-center justify-between px-4 py-2">
        ...
        {/* 💎 Logo */}
        <div onClick={() => navigate("/")} className="py-2 text-2xl font-semibold text-yellow-400 tracking-wide">
          Tour Travel
        </div>

        {/* 🔍 Search (Desktop only) */}
        <div className="hidden md:flex items-center bg-white/10 px-3 py-1.5 rounded-lg w-[45%] border border-gray-700">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={() => navigate("/login")} className="text-gray-400 hover:text-yellow-400 transition">
      ...
      {/* <div className="md:hidden px-4 pb-2">
        <div className="flex items-center bg-white/10 px-3 py-1.5 rounded-lg border border-gray-700">
          <FaSearch className="text-gray-400 mr-2 text-sm" />
          <input
            type="text"
            placeholder="Search..."
